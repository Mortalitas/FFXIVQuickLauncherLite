...
namespace XIVLauncher.Accounts
{
    public class AccountManager
    {
        ...
        private static readonly string ConfigPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "XIVLauncherLite", "accountsList.json");
